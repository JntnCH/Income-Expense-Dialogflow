...
// การกำหนดค่า
const CONFIG = {
  SHEET_ID: PropertiesService.getScriptProperties().getProperty('SHEET_ID') || 'your_spreadsheet_id_here',
  SHEET_NAME: 'Transactions',
  LOG_SHEET_NAME: 'TaxLogs',
  COLUMNS: {
    DATE: 0, // คอลัมน์วันที่
    TYPE: 1, // คอลัมน์ประเภท (Income/Expense)
    AMOUNT: 3 // คอลัมน์จำนวนเงิน
  },
  MIN_YEAR: 2000,
